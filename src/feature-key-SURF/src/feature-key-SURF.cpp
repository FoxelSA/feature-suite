 ...
 */
    ...
    int main ( int argc, char ** argv ) {
        ...
        stdp( stda( argc, argv, "--extended", "-t" ), argv, & fsSURFextended, FS_INT    );
        stdp( stda( argc, argv, "--upright" , "-u" ), argv, & fsSURFupright , FS_INT    );
        stdp( stda( argc, argv, "--layer"   , "-l" ), argv, & fsSURFlayers  , FS_INT    );
        stdp( stda( argc, argv, "--octave"  , "-a" ), argv, & fsSURFoctave  , FS_INT    );
        stdp( stda( argc, argv, "--hessian" , "-s" ), argv, & fsSURFhessian , FS_FLOAT  );
