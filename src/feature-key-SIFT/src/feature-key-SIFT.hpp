 ...
 */
    ...
    # ifndef __FS_KEY_SIFT__
    # define __FS_KEY_SIFT__
 ...
 */
    ...
    "\tfeature-key-SIFT [Arguments] [Parameters] ...\n\n"  \
    "Short arguments and parameters summary :\n\n"         \
    "\t-i\tInput image\n"                                  \
    "\t-o\tOutput keypoints file\n"                        \
    "\t-m\tSIFT nfeatures\n"                               \
    "\t-a\tSIFT nOctaveLayers\n"                           \
 ...
 */
     ...
     *  input image is imported in grayscale mode and OpenCV SIFT implementation 
     *  is called to generate the keypoints. The keypoint list is then exported in
     *  the output file.
     *  
