 ...
 */
    ...
    "\tfeature-key-view [Arguments] [Parameters] ...\n\n"  \
    "Short arguments and parameters summary :\n\n"         \
    "\t-i\tInput image\n"                                  \
    "\t-o\tOutput image\n"                                 \
    "\t-k\tInput keypoints file\n\n"                       \
    "feature-key-view - feature-suite\n"                   \
    "Copyright (c) 2013-2014 FOXEL SA - http://foxel.ch\n"
 ...
 */
     ...
     *  The input image is imported in grayscale mode and the keypoints file is
     *  read. The keypoints are drawn on the grayscale image that is then 
     *  exported.
     *  
