 ...
 */
    ...
    int main( int argc, char ** argv ) {
        ...
        stdp( stda( argc, argv, "--strict"   , "-s" ), argv,   fsSMatchfile, __STDP_STRING );
        stdp( stda( argc, argv, "--input"    , "-i" ), argv,   fsIMatchfile, __STDP_STRING );
        stdp( stda( argc, argv, "--output"   , "-o" ), argv,   fsOMatchfile, __STDP_STRING );
        stdp( stda( argc, argv, "--tolerence", "-t" ), argv, & fsTolerence , __STDP_FLOAT  );
